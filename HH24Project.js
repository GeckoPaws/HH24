...
// music -- ISA
const mainMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/grhaiqgy/001%20Title%20Theme.mp3");
mainMusic.loop = true;

const oxMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/hulgofoq/006%20Trail%201%20Good.mp3");
oxMusic.loop = true;

const boxMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/khhmlora/005%20Kanesville%2C%20Council%20Bluffs.mp3");
boxMusic.loop = true;

const beesMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/wnynpdgq/021%20Trail%202%20Poor.mp3");
beesMusic.loop = true;

const goodBoxMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/ujapimen/032%20Trail%203%20Good.mp3");

goodBoxMusic.loop = true;

const riverMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/eitlrgms/022%20Down%20In%20The%20Valley.mp3");

riverMusic.loop = true;

const townMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/ybnhyccg/009%20Go%20Tell%20Aunt%20Rhody%20%28Town%29.mp3");

townMusic.loop = true;

const storeMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/ferblmzs/013%20Jimmy%20Crack%20Corn%20%28Fort%29.mp3");
storeMusic.loop = true;

const huntMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/iasxwiwx/055%20Buffalo%20Gals%20%28Town%29.mp3");
huntMusic.loop = true;

const winMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/ilsubhrx/064%20You%27ve%20Reached%20Your%20Destination%21.mp3");
winMusic.loop = true;

const loseMusic = new Audio("https://vgmdownloads.com/soundtracks/oregon-trail-2-ost/pegpgqml/048%20Trail%204%20Poor.mp3");
loseMusic.loop = true;
...
const game = {
	...
	startGame: function(pName) 
  {
		...
		const $healthTracker = $("<h2 id='healthStatus'>Wagon Status: " + this.healthStatus + "</h2>");
		...
		$message.text(`Howdy ${player.characterName} ! Welcome to the Wild Wild Aggieland, woof ! `);
		...
		$(".main-game-image").append($("<img id='main-game-image' src='https://f2.toyhou.se/file/f2-toyhou-se/images/89191695_WwutsmfkFLJ61gN.gif'>"));
	}
	//PLAYER SPRITE WALK

	$(".cowswalking").append($("<img id='cows' src='https://f2.toyhou.se/file/f2-toyhou-se/images/89196640_nLC6rNINPk8hngT.png'>"));
...
$("body").on("click", "#run-button",
function() {
	game.decideSpeed("run");
});

$("body").on("click", "#walk-button",
function() {
	game.decideSpeed("walk");
});

$("body").on("click", "#stroll-button",
function() {
...
function() {
	...
	function makeButtons() {
		...
		$walkButtons.append($("<button id='stop-button'>Move very slowly (Gain HP)</button>"));
	}
