  ...
  const game = {
    ...
    startGame: function(pName) {
      ...
      $(".main-game-image").append(
        $(
          "<img id='main-game-image' src='https://cdn.discordapp.com/attachments/854460161456734249/1289842106847854684/background2.gif?ex=66fa4a92&is=66f8f912&hm=99b36d6fe451e6e8de2b3fc34801e4c892fb32fb969028237071619bb1f02cae&'>"
        )
      );
